...
set.seed(12345) #책에 설명한 결과 동일하게 하려고
credit_rand <- credit[order(runif(1000)), ]

# set.seed(123)
# credit_train <- credit[order(runif(1000)), 900]
...
library(C50)
credit_model <- C5.0(credit_train[-17], credit_train$default) #17번이 답
...
library(carat)
# Adaptive_Boosting -> 오류를 일으킨 표본을 더 강제적으로 집어 넣음
